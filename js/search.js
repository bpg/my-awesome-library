...
function prepareIdxAndDocMap() {
  const docs = [  
    {
      "title": "Change Log",
      "url": "/my-awesome-library/CHANGELOG.html",
    ...
    } ,    
    {
      ...
      "url": "/my-awesome-library/core/example.html",
      "content": "Example Just a sample document. Scala code import cats.implicits._ import my.awesome.library.Example Example.sumAll(List(1, 2, 3, 4))"
    } ,    
    {
      "title": "Home",
      "url": "/my-awesome-library/",
      "content": "My Awesome Library An awesome public FP library. Usage The packages are published on Maven Central. libraryDependencies += \"com.github.bpg\" %% \"my-awesome-library-core\" % \"&lt;version&gt;\" Documentation Links: Website API documentation Contributing The My Awesome Library project welcomes contributions from anybody wishing to participate. All code or documentation that is provided must be licensed with the same license that My Awesome Library is licensed with (Apache 2.0, see LICENCE). People are expected to follow the Scala Code of Conduct when discussing My Awesome Library on GitHub, Gitter channel, or other venues. Feel free to open an issue if you notice a bug, have an idea for a feature, or have a question about the code. Pull requests are also gladly accepted. For more information, check out the contributor guide. License All code in this repository is licensed under the Apache License, Version 2.0. See LICENCE."
    } ,        
  ];
